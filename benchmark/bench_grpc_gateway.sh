...
DEFAULT_RESULTS_DIR="benchmark/results/grpc_gateway" # 결과 저장 디렉토리
...
for (( i=0; i<num_tests; i++ )); do
  ...
  if [ $? -ne 0 ]; then
    ...
    echo "gRPC gateway API benchmark" >> "$RESULTS_FILE"
...
echo "=================================================="
echo "All gRPC gateway API benchmark runs completed."
